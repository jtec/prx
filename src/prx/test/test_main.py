...
def test_prx_function_call_with_csv_output(input_for_test_tlse):
    ...
    # In such a short period we expect at most one transition from one ephemeris to the next one
