...
def test_csv_format():
    ...
    csv_file = helpers.prx_repository_root().joinpath(
        "tools/validation_data/TLSE00FRA_R_20230010100_10S_01S_MO.csv"
    )
    ...
    fields_expected = [
        ...
        "observation_code",
        "code_observation_m",
        "doppler_observation_hz",
        "carrier_observation_m",
        "lli",
        "cn0_dbhz",
        ...
        "iono_delay_m",
        "tropo_delay_m",
        "approximate_antenna_position_m",
    ]
    ...
    assert data_prx.iloc[0].time_of_reception_in_receiver_time == pd.Timestamp(
        "2023-01-01 01:00:00"
    )
