...
def main():
    ...
    rx_base_obs = anything_to_rinex_3(
        Path(__file__).parent / "obs/TLSE00FRA_R_20241900000_15M_01S_MO.crx.gz"
    )
    rx_rover_obs = anything_to_rinex_3(
        Path(__file__).parent / "obs/TLSG00FRA_R_20241900000_15M_01S_MO.crx.gz"
    )
